...
public final class GSPanelContext {
	...
	private static final Identifier UI_TEXTURE_IDENTIFIER = Identifier.fromNamespaceAndPath("g4mespeed-ui", "textures/ui.png");
	...
	private void setGLFWCursor(int cursorType) {
		...
		GLFW.glfwSetCursor(client.getWindow().handle(), cursorPtr);
	}
